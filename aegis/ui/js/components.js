...
export function renderPagination(offset, limit, currentCount, onPageChange) {
    ...
    wrapper.innerHTML = `
        ...
        <div class="pagination-controls">
            <button id="prev-page-btn" class="btn btn-secondary btn-sm" ${offset === 0 ? 'disabled' : ''}>◀ Previous</button>
            <button id="next-page-btn" class="btn btn-secondary btn-sm" ${!hasNext ? 'disabled' : ''}>Next ▶</button>
        </div>
    `;
