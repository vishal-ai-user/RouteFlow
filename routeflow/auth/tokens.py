"""RouteFlow token validation — Verify gateway authentication tokens.

Follows SECURITY.md §4 and ARCHITECTURE.md §6:
- verify API tokens against the configured ROUTEFLOW_AUTH_TOKEN
...
def validate_token(token: str) -> bool:
    ...
    if settings.auth_token is None:
        ...
        logger.warning("ROUTEFLOW_AUTH_TOKEN is not configured — auth is disabled")
        return True
